...
async def gen_link_s(client: Client, message):
    ...
    original_link_button = InlineKeyboardButton("Original Link", url=share_link)
    short_link_button = InlineKeyboardButton("Short Link", url=short_link)
    keyboard = [[original_link_button, short_link_button]]
